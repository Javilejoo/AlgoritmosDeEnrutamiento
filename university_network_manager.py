"""
Gestor de red universitaria
Maneja múltiples nodos con el protocolo universitario específico
"""
...
from university_protocol import UniversityMessageFactory

class UniversityNetworkManager:
    """Gestor para redes universitarias"""
    
    def __init__(self):
        self.nodes = {}  # {node_id: UniversityNode}
    ...
    def add_node(self, node_id: str, port: int, algorithm: str = "flooding"):
        ...
        node = UniversityNode(node_id, port, algorithm)
    ...
    async def start_network(self):
        ...
        print("🚀 Iniciando red universitaria...")
    ...
    async def stop_network(self):
        ...
        print("🛑 Deteniendo red universitaria...")
    ...
    def print_network_status(self):
        ...
        print("\n" + "="*50)
        print("📊 ESTADO DE LA RED UNIVERSITARIA")
        print("="*50)
    ...
    @classmethod
    def load_network_config(cls, filename: str) -> 'UniversityNetworkManager':
...
# Demo completo
async def demo_university_network():
    """Demo completo de red universitaria"""
    print("=== DEMO RED UNIVERSITARIA COMPLETA ===\n")
    ...
    try:
        ...
        manager.save_network_config("university_network_config.json")
        
    finally:
        await manager.stop_network()

if __name__ == "__main__":
    asyncio.run(demo_university_network())
