"""
Interfaz principal para el protocolo de red distribuida
Sistema de enrutamiento con algoritmos Flooding y LSR
"""
...
class RoutingSystemInterface:
    """Interfaz principal para el sistema de enrutamiento"""
    ...
    async def run(self):
        ...
        print("🌐 Bienvenido al sistema de enrutamiento distribuido")
    ...
    async def load_network(self):
        ...
        if os.path.exists(filename):
            try:
                self.manager = NetworkManager.load_network_config(filename)
...
async def main():
    """Función principal"""
    interface = RoutingSystemInterface()
    await interface.run()

if __name__ == "__main__":
    print("🌐 INICIANDO SISTEMA DE ENRUTAMIENTO DISTRIBUIDO...")
    asyncio.run(main())
